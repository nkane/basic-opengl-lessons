/*
 * Exercise 1
 * - Can you make it so that changing the light color changes
 *   the color of the light's cube object?
 */
...
main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        process_input(window);
        {
            ...
            SetFloatVec3Uniform(light_shader_program, "u_light_color", light_color);
