/*
 * Exercise 1
 * - Fool around with the light source's ambient, diffuse and specular vectors
 *   and see how they affect the visual output of the container.
 */
...
main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        process_input(window);
        {
            ...
            SetFloatVec3Uniform(shader_program, "u_light.diffuse", glm::vec3(1.0f, 0.5f, 0.5f));
            SetFloatVec3Uniform(shader_program, "u_light.specular", glm::vec3(1.0f, 0.0f, 0.0f));
            glDrawArrays(GL_TRIANGLES, 0, 36);
