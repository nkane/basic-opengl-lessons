...
main()
{
    ...
    ShaderProgram *model_shader = CreateShaderProgram("shaders/vertex_model.glsl", "shaders/fragment_model.glsl");;
    if (!model_shader)
    {   
        printf("[SHADER ERROR]: failed to load model shader\n");
    }

    Model *model_obj = CreateModel("assets/backpack.obj");
    if (model_obj) 
    {
        printf("[INFO]: successfully created model\n");
    }
    ...
    while (!glfwWindowShouldClose(window))
    {
        process_input(window);
        {
            ...
            DrawModel(model_obj, model_shader);
    ...
    
    {
        ...
        ReleaseShaderProgram(model_shader);
