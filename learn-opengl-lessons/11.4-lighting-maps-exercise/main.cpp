/*
 *  Exercise 3
 *  - Try creating a specular map from the diffuse texture that uses
 *    actual colors instead of black and white and see that the result
...
main()
{
    ...
    stbi_set_flip_vertically_on_load(true);
    container_metal_outline_texture.data = stbi_load("assets/lighting_maps_specular_color.png",
