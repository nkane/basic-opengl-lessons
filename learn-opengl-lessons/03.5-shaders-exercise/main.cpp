/*
 * Exercise 2
 * - Specify a horizontal offset via a uniform and move the triangle to the right side of
 *   the screen in the vertex shader using this offset value.
 */
...
main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        process_input(window);
        {
            ...
            SetFloatUniform(shader_program, "u_offset", 0.5f);
            glBindVertexArray(vertex_array_id);
