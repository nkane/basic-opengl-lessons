...
int DrawGLScene(GLvoid)
{
	...
	// move view left 1.5 units and into 6.0 units
	glTranslatef(-1.5f, 0.0f, -6.0f);

	// NOTE: glRotatef(angle, xVector, yVector, zVector)
	...
	{
		// set top point and color to red
		glColor3f( 1.0f, 0.0f, 0.0f );
		glVertex3f( 0.0f, 1.0f, 0.0f );

		// set left point and color to green
		glColor3f( 0.0f, 1.0f, 0.0f );
		glVertex3f( -1.0f, -1.0f, 0.0f );

		// set right point and color to blue
	...
	// move view right 1.5 units and into 6.0 units
	glTranslatef(1.5f, 0.0f, -6.0f);
	...
	glRotatef(trianglerotation, 1.0f, 1.0f, 1.0f);
	...
	// increase triangle rotation
	//trianglerotation += 0.2f;
	// NOTE: increased amounts will rotate faster
	trianglerotation += 1.0f;

	// decrease quad rotation
	quadrotation -= 0.15f;
	// NOTE: increased amounts will rotate faster
	//quadrotation -= 1.15f;
