...
int DrawGLScene(GLvoid)
{
	...
	//  reset the current view model matrix
	glLoadIdentity();

	// move 1.5 units left and 6.0 units into the screen
	glTranslatef(-1.5f, 0.0f, -6.0f);
	
	// begin drawing triangles
	glBegin(GL_TRIANGLES);
	{
		// NOTE: glColor3f(red, green, blue)
	...
	// move 3.0 units from current view position to right
	glTranslatef(3.0f, 0.0f, 0.0f);

	// set the color to blue - one time
